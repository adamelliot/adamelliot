...
module Application
  module Javascripts
    APP_SCRIPTS = %w[inflection.js pure_packed.js modernizr-1.5.min.js jquery.tweet.js jquery.ba-hashchange.min.js framework.js menu.js toy.js pics.js controllers.js application.js]
